package com.four.utils.ecpay.payment.integration.ecpayOperator;
...
public class PaymentVerifyBase{
	protected String confPath = "/com/four/utils/ecpay/payment/integration/config/EcpayPayment.xml";
